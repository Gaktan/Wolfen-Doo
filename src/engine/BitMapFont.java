...
public class BitMapFont {
	...
	public DisplayableText createString(Vector3 position, String str, float textSize, Color color, TextPosition textPosition, boolean hasDepth) {
		DisplayableText text = new DisplayableText(position, str, this, textSize, color, textPosition, hasDepth);
		return text;
	}

	public DisplayableText createString(Vector3 position, String str, float textSize, TextPosition textPosition, boolean hasDepth) {
