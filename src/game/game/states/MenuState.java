...
import engine.game.MouseListener;
...
import game.entities.MenuButton;
import game.entities.MenuButton.ButtonRelease;
...
public class MenuState extends GameState implements MouseListener {
	...
	public void init() {
		...
		final MenuButton playButton = new MenuButton(buttonShape, "Generate map", new Vector3(0f, 0.2f, 0f), 0.9f, bmf);
		...
		final MenuButton quitButton = new MenuButton(buttonShape, "Quit", new Vector3(0f, -0.3f, 0f), 0.9f, bmf);
	...
	public void onMouseRelease(int button) {
		...
		if (button == 0) {
			if (selectedButton != null) {
				...
				selectedButton.onButtonRelease(cursorRect.collide(buttonRect));
				selectedButton = null;
			}
		}
	}
